...
class NewNoticesWidget extends StatefulWidget {
  const NewNoticesWidget({Key? key}) : super(key: key);

  @override
  State<NewNoticesWidget> createState() => _NewNoticesWidgetState();
}

class _NewNoticesWidgetState extends State<NewNoticesWidget> {
  String? _chosenValue;
  String? noticeIds;
  String? dutyTypes;
  var resbody;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        if (sortedNoticeList.isNotEmpty)
          Card(
            shape:
